...
<body>
    <div class="container mt-4">
        ...
        <div class="mb-3">
            ...
            <a href="?order_by=porcentaje_reseñas&direction=ASC" class="btn btn-info">Ordenar por reseñas (Asc)</a>
            <a href="?order_by=porcentaje_reseñas&direction=DESC" class="btn btn-info">Ordenar por reseñas (Desc)</a>
            ...
            <tbody>
                <?php
                    ...
                    while ($fila = $res->fetch_assoc()) {
                        ...
                        echo "<td>{$fila['porcentaje_reseñas']}</td>";
